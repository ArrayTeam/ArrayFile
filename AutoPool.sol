...
contract AutoPool is Ownable {
    uint public constant MAX_INT =
        0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
    IUniRouter02 public router =
        IUniRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    // IUniRouter02 public router =
    //     IUniRouter02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);

    address public usdt = 0x55d398326f99059fF775485246999027B3197955;
    address public token1 = 0xC2980e31930A40a547941a3a08e011521Ee9EE44;
    address public pair = 0xA1eBDc3b6044C259B154f465fe106a3AB35EC865;
    ...
    function setUni(address router_) public onlyAdmin {
        router = IUniRouter02(router_);
    }
    ...
    function addLiquidityAuto() public {
        uint256 toAdd = IERC20(token1).balanceOf(address(this));

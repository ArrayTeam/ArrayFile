...
contract ARRAYFINANCE3 is OwnableUpgradeable {
    ...
    function stake(uint amount_, uint slot_) public onlyEOA {
        ...
        IERC20(addr.ARRAY).transferFrom(msg.sender, address(this), amount_);
        emit Stake(
            msg.sender,
    ...
    function withdraw(uint slot_) public onlyEOA returns (uint _amount) {
        ...
        if (_amount != 0) {
            ...
            IERC20(addr.ARRAY).transfer(msg.sender, _amount);
